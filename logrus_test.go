...
import (
	...
	. "github.com/bnulwh/logrus/internal/testutils"
)
...
func TestReportCallerWhenConfigured(t *testing.T) {
	...
	LogAndAssertJSON(t, func(log *Logger) {
		...
		assert.Equal(t, "info", fields["level"])
		assert.Equal(t,
			"github.com/bnulwh/logrus_test.TestReportCallerWhenConfigured.func3", fields[FieldKeyFunc])
	})
...
func TestGlobalLevelEnabled(t *testing.T) {
	oldLevel := GetLevel()
	defer SetLevel(oldLevel)

	SetLevel(PanicLevel)
	assert.Equal(t, true, IsPanicEnabled())
	assert.Equal(t, false, IsFatalEnabled())
	assert.Equal(t, false, IsErrorEnabled())
	assert.Equal(t, false, IsWarnEnabled())
	assert.Equal(t, false, IsInfoEnabled())
	assert.Equal(t, false, IsDebugEnabled())
	assert.Equal(t, false, IsTraceEnabled())

	SetLevel(FatalLevel)
	assert.Equal(t, true, IsPanicEnabled())
	assert.Equal(t, true, IsFatalEnabled())
	assert.Equal(t, false, IsErrorEnabled())
	assert.Equal(t, false, IsWarnEnabled())
	assert.Equal(t, false, IsInfoEnabled())
	assert.Equal(t, false, IsDebugEnabled())
	...
	assert.Equal(t, true, IsPanicEnabled())
	assert.Equal(t, true, IsFatalEnabled())
	assert.Equal(t, true, IsErrorEnabled())
	assert.Equal(t, false, IsWarnEnabled())
	assert.Equal(t, false, IsInfoEnabled())
	assert.Equal(t, false, IsDebugEnabled())
	assert.Equal(t, false, IsTraceEnabled())
	...
	assert.Equal(t, true, IsFatalEnabled())
	assert.Equal(t, true, IsErrorEnabled())
	assert.Equal(t, true, IsWarnEnabled())
	assert.Equal(t, false, IsInfoEnabled())
	assert.Equal(t, false, IsDebugEnabled())
	assert.Equal(t, false, IsTraceEnabled())
	...
	assert.Equal(t, true, IsErrorEnabled())
	assert.Equal(t, true, IsWarnEnabled())
	assert.Equal(t, true, IsInfoEnabled())
	assert.Equal(t, false, IsDebugEnabled())
	assert.Equal(t, false, IsTraceEnabled())
	...
	assert.Equal(t, true, IsInfoEnabled())
	assert.Equal(t, true, IsDebugEnabled())
	assert.Equal(t, true, IsTraceEnabled())
}
